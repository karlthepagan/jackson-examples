...
public interface JsonWrap {
    ...
    class RootInput<T> extends Root<T> {
        ...
        public static JavaType wrapType(JavaType type) {
            return TypeFactory.defaultInstance().constructParametricType(RootInput.class, type);
        }
    }
    ...
    class RootOutput<T> extends Root<T> {
        ...
        public static JavaType wrapType(JavaType type) {
            return TypeFactory.defaultInstance().constructParametricType(RootOutput.class, type);
        }
    }
}
